...
public class ArrayBagTest
{
	public static void main(String[] args) 
	{
      ...
      ArrayBag<String> aBag = new ArrayBag<>(contentsOfBag.length);
   ...
   // Tests the method add.
	private static void testAdd(ArrayBag<String> aBag, String[] content)
	{
   ...
   // Tests the two remove methods.
	private static void testRemove(ArrayBag<String> aBag, String[] tests)
	{
      for (int index = 0; index < tests.length; index++)
      {
         ...
         else
         {
            ...
            boolean result = aBag.rmve(aString);
   ...
   // correctResult indicates what isEmpty should return.   
	private static void testIsEmpty(ArrayBag<String> aBag, boolean correctResult)
	{
   ...
   // Tests the method getFrequencyOf.
	private static void testFrequency(ArrayBag<String> aBag, String[] tests)
	{
   ...
   // Tests the method contains.
	private static void testContains(ArrayBag<String> aBag, String[] tests)
	{
   ...
   // Tests the method toArray while displaying the bag.
	private static void displayBag(ArrayBag<String> aBag)
	{
